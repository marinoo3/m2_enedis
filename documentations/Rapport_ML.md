...
ayant pour objectif de garder un modèle simple, et avec des ordinateurs dont les performances sont assez limitées, nous avons opté pour assez peu de paramètres lors du GridSearch.
