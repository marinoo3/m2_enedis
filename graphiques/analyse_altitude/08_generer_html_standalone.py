"""
Génération d'un fichier HTML standalone avec images encodées en base64
Mountain Energy Score - Haute-Savoie

Ce script crée un fichier HTML unique contenant toutes les images intégrées,
parfait pour partager par email sans dépendances externes.
"""
...
print("\n" + "="*80)
print("GÉNÉRATION DU FICHIER HTML STANDALONE")
print("="*80 + "\n")
...
print("📦 Encodage des images en base64...\n")

graphiques_path = Path("graphiques")

# Liste des images à encoder
images = [
    "01_scatter_altitude_consommation.png",
    "02_boxplot_altitude_consommation.png",
    "03_barplot_surcout_altitude.png",
    "04_graphiques_barres_dpe.png",
    "05_heatmap_periode_altitude.png"
]

# Encoder chaque image
images_base64 = {}
for img in images:
    img_path = graphiques_path / img
    if img_path.exists():
        with open(img_path, 'rb') as f:
            img_data = base64.b64encode(f.read()).decode()
            images_base64[img] = f"data:image/png;base64,{img_data}"
        print(f"   ✅ {img} encodée ({img_path.stat().st_size / 1024:.0f} KB)")
    else:
        print(f"   ⚠️  {img} introuvable, sera ignorée")
    ...
    <div class="container">
        ...
        <div class="story">
            ...
            <p>
                ...
                (+1,363€/an en montagne) et une concentration de logements énergivores en altitude. L'analyse révèle également 
                un pallier critique à 1200m au-delà duquel la consommation se stabilise, identifiant la zone 600-1200m 
                comme la transition énergétique la plus sensible. L'analyse croisée avec la période de construction permet 
                d'identifier précisément les 13,432 logements anciens en montagne comme cible optimale pour maximiser 
                l'efficacité des politiques de rénovation énergétique dans le département.
            </p>
        </div>
        
        <div class="graphique">
            <img src="{images_base64.get('01_scatter_altitude_consommation.png', '')}" alt="Graphique 1 : Corrélation altitude et consommation">
        </div>
        
        <div class="graphique">
            <img src="{images_base64.get('02_boxplot_altitude_consommation.png', '')}" alt="Graphique 2 : Distribution par tranche d'altitude">
        </div>
        
        <div class="graphique">
            <img src="{images_base64.get('03_barplot_surcout_altitude.png', '')}" alt="Graphique 3 : Surcoût financier par altitude">
        </div>
        
        <div class="graphique">
            <img src="{images_base64.get('04_graphiques_barres_dpe.png', '')}" alt="Graphique 4 : Concentration des passoires thermiques">
        </div>
        
        <div class="graphique">
            <img src="{images_base64.get('05_heatmap_periode_altitude.png', '')}" alt="Graphique 5 : Double peine ancienneté et altitude">
        </div>
...
output_file = graphiques_path / "Mountain_Energy_Score_STANDALONE.html"
...
print("="*80)
print("✅ FICHIER STANDALONE GÉNÉRÉ")
print("="*80)
print(f"\n📧 Tu peux maintenant envoyer ce fichier unique par email :")
print(f"   {output_file}")
print(f"\n💡 Tes collègues n'auront qu'à ouvrir ce fichier dans un navigateur,")
print(f"   aucune dépendance externe nécessaire !\n")

if file_size_mb > 25:
    print("⚠️  Attention : Le fichier dépasse 25 MB, certains emails pourraient bloquer.")
    print("   → Utilise WeTransfer ou un service de partage de fichiers\n")